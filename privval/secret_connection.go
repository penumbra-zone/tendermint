...
import (
	...
	"github.com/penumbra-zone/tendermint/crypto/encoding"
	"github.com/penumbra-zone/tendermint/internal/libs/async"
	"github.com/penumbra-zone/tendermint/internal/libs/protoio"
	tmprivval "github.com/penumbra-zone/tendermint/proto/tendermint/privval"
)
...
// https://github.com/penumbra-zone/tendermint/issues/4698
...
// See https://github.com/penumbra-zone/tendermint/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/penumbra-zone/tendermint/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) error {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/penumbra-zone/tendermint/issues/3531
