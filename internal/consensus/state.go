...
import (
	...
	"github.com/penumbra-zone/tendermint/internal/libs/autofile"
	...
	tmgrpc "github.com/penumbra-zone/tendermint/privval/grpc"
...
func (cs *State) handleMsg(ctx context.Context, mi msgInfo) {
	...
	case *VoteMessage:
		...
		// a typical peer.
		// https://github.com/penumbra-zone/tendermint/issues/1281
...
func (cs *State) tryAddVote(ctx context.Context, vote *types.Vote, peerID types.NodeID) (bool, error) {
	...
	if err != nil {
		...
		if voteErr, ok := err.(*types.ErrVoteConflictingVotes); ok {
			...
			//		(https://github.com/penumbra-zone/tendermint/issues/3839).
...
func (cs *State) addVote(
	...
	if cs.state.ConsensusParams.ABCI.VoteExtensionsEnabled(cs.Height) {
		...
		// https://github.com/penumbra-zone/tendermint/issues/8487
		...
		// https://github.com/penumbra-zone/tendermint/issues/8565
